...
//	float MyResource::ConfigTable::ServoConfig::NormalWeightHD = 0.4615385f;
	...
	float MyResource::ConfigTable::ServoConfig::TurningKpA =  348.0f; //250.0f;
	float MyResource::ConfigTable::ServoConfig::TurningKpB = 340.0f; //308;//120.0f;
//	float MyResource::ConfigTable::ServoConfig::TurningKi = 0.0f;
	float MyResource::ConfigTable::ServoConfig::TurningKd = 18.0f;
...
//	float MyResource::ConfigTable::ServoConfig::TurningWeightHD = 0.525f;
	...
	float MyResource::ConfigTable::ServoConfig::Turning90DegreeThresholdSd = 0.3f;
	float MyResource::ConfigTable::ServoConfig::SdNoSignalThreshold = 0.670f;
